...
require_once('WebServiceImpl.php');

/**
 * This ia an abstract class for the soapservice. All the global fun
 *
 */
abstract class SoapService extends WebService{
	protected $soap_version = '1.1';
	protected $namespace = 'http://cil-rest/';
	protected $implementationClass = 'WebServiceImpl';
